            ...
            <div class="card-body">
                ...
                <form action="user_edit_db.php" method="post">
                    <div class="form-group">
                        <label for="">Edit Your Username</label>
                    ...
                    <div class="form-group">
                        <label for="">Edit Your Password</label>
                    ...
                    <div class="form-group">
                        <label for="">Edit Your Fullname</label>
                        <input type="text" name="fullname"  class="form-control" placeholder="กรอกชื่อ-นามสกุล"
                            aria-describedby="helpId">
                        <small id="helpId" class="text-muted">Help text</small>
                    </div>

                    <div class="form-group">
                        <label for="">Edit Your Mail</label>
                        <input type="email" name="mail" class="form-control" placeholder="กรอกอีเมล"
                            aria-describedby="helpId">
                        <small id="helpId" class="text-muted">Help text</small>
                    </div>

                    <div class="form-group">
                        <a href="user_edit_db.php?userid=<?php echo $row['userid'] ?>" class="btn btn-success"
                            onclick="return confirm('คุณต้องการบันทึกการแก้ไขข้อมูลใช่หรือไม่ ')">confirm</a>
                    </div>

                    <br>
                    <br>
                    <div class="form-group">
                        <a href="l.php" class="form-control btn btn-warning col-3">
                            < กลับไปยังหน้าหลัก</a>
                    </div>
                </form>
            </div>
