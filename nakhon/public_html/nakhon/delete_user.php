    ...
    <div class="container">
        ...
        <div class="card text-left">
            ...
            <div class="card-body">
                ...
                <p class="card-text">ยกเลิกสิทธิ์ผู้ใช้งานในระบบ</p>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a href="du_db.php?userid=<?php echo $row['userid'] ?>" class="btn btn-danger"
                                    onclick="return confirm('คุณต้องการยกเลิกสิทธิ์การใช้งานของผู้ใช้รายนี้ใช่หรือไม่ ');">cancel</a>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
