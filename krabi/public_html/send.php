    ...
    <div class="panel panel-primary">
          ...
          <div class="panel-body">
                <?php
                    ...
                    $sql="SELECT * from friends where f_ownerid='$id' and f_status='1'";
                    ...
                    if($num==0){
                        ...
                        <div class="alert alert-warning">
                            ...
                            <strong>ไม่มีการส่งคำขอเป็นเพื่อน!</strong>
                        </div>
                   <div class="row">
                        <?php
                        }else{
                ...
                ?>
                    ...
                    <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                        ...
                        <?php echo $row['m_name']; ?><br>
                            ...
                            <a href="cancel.php?mid=<?php echo $row['m_id'];?>" class="btn btn-warning btn-block btn-sm">
                            ยกเลิกส่งคำขอ
                            </a>
                            </p>
