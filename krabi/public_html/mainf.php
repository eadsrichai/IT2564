...
<body>
    ...
    $id=$_SESSION['sid'];
    $sqlp="SELECT * from post where p_status!='3' and p_memid='$page' ORDER by p_id desc";
    ...
    <div class="panel panel-primary">
          ...
          <!-- LOVE -->
                    ...
                    <form action="savelovef.php" method="POST" class="form-horizontal" role="form">
          ...
          <!-- CMM -->
                    ...
                    <form action="savecmmf.php" method="POST" class="form-inline" role="form" align="right" style="margin-right:20px;">
                    ...
                    ?>
                        ...
                        <div class="media" style="margin-left:10px;">
                            ...
                            <div class="media-body">
                                ...
                                ?>
                                <a href="delcmmf.php?mid=<?php echo $rowc['c_id'];?>&page=<?php echo $page;?>">
                                ...
                                <form action="editcmmf.php" method="POST" class="form-inline" role="form">
