...
<body>
    ...
    $id=$_SESSION['sid'];
    $sqlp="SELECT * from post where p_status='1' and p_memid='$page' ORDER by p_id desc";
    ...
    <div class="panel panel-primary">
          ...
          <!-- LOVE -->
                    ...
                    <form action="saveloves.php" method="POST" class="form-horizontal" role="form">
                            ...
                            <div class="form-group" style="margin-left:10px;">
                                <div class="col-sm-12">
                                    ...
                                    <input type="hidden" name="mid" value="<?php echo $page;?>">
                                </div>
                            </div>
                    </form>
          ...
          <!-- CMM -->
                    ...
                    <form action="savecmms.php" method="POST" class="form-inline" role="form" align="right" style="margin-right:20px;">
                    ...
                    ?>
                        ...
                        <div class="media" style="margin-left:10px;">
                            ...
                            <div class="media-body">
                                ...
                                ?>
                                <a href="delcmms.php?mid=<?php echo $rowc['c_id'];?>&page=<?php echo $page;?>">
                                ...
                                <form action="editcmms.php" method="POST" class="form-inline" role="form">
