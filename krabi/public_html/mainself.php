...
<body>
    ...
    $id=$_SESSION['sid'];
    $sqlp="SELECT * from post where p_memid='$id'  ORDER by p_id desc";
    ...
    <div class="panel panel-primary">
          <div class="panel-heading">
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading"><?php echo $rowm['m_name'];?>
                        <a href="delpost.php?pid=<?php echo $rowp['p_id'];?>">

                        
                        <span class="glyphicon glyphicon-trash" aria-hidden="true" style="color:white"></span>
                        
                        </a>
                        <a data-toggle="collapse" data-target="#demo<?php echo $rowp['p_id'];?>">
                        <span class="glyphicon glyphicon-pencil" aria-hidden="true" style="color:white"></span>
                        </a>
                        <!--COLLAPSE-->

                        <div class="collapse" id="demo<?php echo $rowp['p_id'];?>">
                            
                            <form action="editpost.php" method="POST" class="form-inline" role="form">
                            
                                <div class="form-group">
                                    <label class="sr-only" for="">label</label>
                                    <input type="text" value="<?php echo $rowp['p_text'];?>" name="tpost" class="form-control" id="" placeholder="แก้ไขโพสต์">
                                </div>
                            
                                
                                <input type="hidden" name="pid" id="inputpid" class="form-control" value="<?php echo $rowp['p_id'];?>">
                                
                            
                                <button type="submit" class="btn btn-default btn-sm">แก้ไข</button>
                            </form>
          ...
          <!-- LOVE -->
                    ...
                    <form action="saveloveself.php" method="POST" class="form-horizontal" role="form">
          ...
          <!-- CMM -->
                    ...
                    <form action="savecmmself.php" method="POST" class="form-inline" role="form" align="right" style="margin-right:20px;">
                    ...
                    ?>
                        ...
                        <div class="media" style="margin-left:10px;">
                            ...
                            <div class="media-body">
                                ...
                                ?>
                                <a href="delcmmself.php?mid=<?php echo $rowc['c_id'];?>">
                                ...
                                <form action="editcmmself.php" method="POST" class="form-inline" role="form">
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="savepostself.php" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
