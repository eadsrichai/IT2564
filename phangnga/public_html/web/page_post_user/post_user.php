...
<body style="background-color: whitesmoke;">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div>
                    <a href="../page_Edit_user/Edit_information.php"><input type="button" class="btn btn-info shadow p-3" value="แก้ไขข้อมูลส่วนตัว"></a>
                    <a href="../page_post_friend/post_friend.php"><input type="button" class="btn btn-info shadow p-3" value="โพสต์เพื่อน"></a>
                </div>
            </div>
                ...
                <div class="shadow p-3 mb-5 rounded bg-white">
                    <div class="card-body">
                        ...
                        <form action="../services/post_system.php" method="post" enctype="multipart/form-data">
                            ...
                            <br>
                            <div>
                                <input type="file" class="btn btn-info" name="file" id="" style="width:100%">
                            </div>
                            <br>
                            <div align="right">
