...
if (isset($_SESSION['adminid'])) {
    ...
    $count_active = "SELECT * FROM tb_users WHERE u_memberid != $myid AND u_status = 2 ORDER BY u_memberid DESC";
                    ...
                    <div class="card-body">
                        ...
                        ?>
                            <div>
                                ...
                                &nbsp;
                                <label for="">
                                    <p>ชื่อ: <?php echo $fetch_active['u_fname'] . "   " . $fetch_active['u_lname'] ?></p>
                                    <p>ที่อยู่: <?php echo $fetch_active['u_address'] ?></p>
                                    <p>อีเมล: <?php echo $fetch_active['u_email'] ?></p>
                                </label>
                            </div>
                            <br>

                            <div align="right">
                                <a href="../services/admin_system.php<?php echo "?uid=$uid&deactive=1" ?>"><input type="button" class="btn btn-danger shadow" value="ยกเลิกใช้งาน"></a>
                            </div>
                            <br>
