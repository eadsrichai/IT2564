...
if (isset($_SESSION['adminid'])) {
    ...
    $count_active = "SELECT * FROM tb_users WHERE u_memberid != $myid AND u_status = 1";
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card p-1 mt-3" style="background-color:slategrey;">
                    <p class="h5 text-white">ผู้ใช้งานที่ยังไม่ได้รับการอนุมัติ</p>
                </div>
                <div class="shadow p-3 mb-5 rounded bg-white ">
                    ...
                    <div class="card-body">
                        ...
                        ?>
                            ...
                            <div align="right">
                                <a href="../services/admin_system.php<?php echo "?uid=$uid&active=1" ?>"><input type="button" class="btn btn-success shadow" value="อนุมัติ"></a>
                            </div>
                            <br>
