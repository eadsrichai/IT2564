    ...
    <div class="container" >
        <div class="row" " >
            <div class="col text-center  " style="width: 100px;" >
                <form class="form-control mt-4 " action="chk_admin.php" method="post"  style="width:600px ;margin: 0 auto; border-radius: 25px;">
                   <div><br>

                       <h1>HI USER</h1>  
             
                   
                    <p class="p-1 mt-2">ยินดีต้อนรับเข้าสู่ระบบ...</p>
            </div>
